...
val frCobalt        = <liquid:bronze.cobalt>;
val frArdite        = <liquid:bronze.ardite>;
val frAlumite       = <liquid:bronze.alumite>;
...
mods.tconstruct.Smeltery.addMelting( vanillaRedstone, frRedstone * 144, 3000, vanillaRedstoneBlock );
mods.tconstruct.Smeltery.addMelting( vanillaRedstoneBlock, frRedstone * 1296, 3000, vanillaRedstoneBlock );
