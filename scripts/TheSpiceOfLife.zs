...
val foodGroupVegetarianone = [
  <harvestcraft:braisedonionsItem>,   /* 0 - Braised Onions */
  <harvestcraft:broccolimacItem>,   /* 1 - Broccoli Mac */
  <harvestcraft:broccolindipItem>,    /* 2 - Broccoli n Dip */
  <harvestcraft:butteredpotatoItem>,    /* 3 - Buttered Potato */
  <harvestcraft:candiedsweetpotatoesItem>,    /* 4 - Candied Sweet Potatoes */
  <harvestcraft:celeryandpeanutbutterItem>,   /* 5 - Celery and Peanut Butter */
  <harvestcraft:chikorollItem>,   /* 6 -Chiko Roll */
  <harvestcraft:chiliItem>,   /* 7 - Chili */
  <harvestcraft:cinnamonappleoatmealItem>,    /* 8 - Cinnamon Apple Oatmeal */
  <harvestcraft:cornonthecobItem>,    /* 9 - Corn on the Cob */
  <harvestcraft:mashedsweetpotatoesItem>,   /* 10 - Mashed Sweet Potatoes */
  <harvestcraft:mushroomrisottoItem>,   /* 11 - Mushroom Risotto */
  <harvestcraft:omeletItem>,    /* 12 - Omelet */
  <harvestcraft:ovenroastedcauliflowerItem>,    /* 13 - Oven Roasted Cauliflower */
  <harvestcraft:peachesandcreamoatmealItem>,    /* 14 - Peaches and Cream Oatmeal */
  <harvestcraft:peasandceleryItem>,   /* 15 - Peas and Celery */
  <harvestcraft:pickledbeetsItem>,    /* 16 - Pickled Beets */
  <harvestcraft:pickledonionsItem>,   /* 17 - Pickled Onions */
  <harvestcraft:summersquashwithradishItem>,    /* 18 - Summer Squash with Radish */
  <harvestcraft:sweetpotatosouffleItem>,    /* 19 - Sweet Potato Souffle */
  <harvestcraft:toastedcoconutItem>,    /* 20 - Toasted Coconut */
] as IItemStack[];

val foodGroupVegetariantwo = [
  <harvestcraft:avocadoburritoItem>,    /* 0 - Avocado Burrito /*
  <harvestcraft:bakedbeansItem>,    /* 1 - Baked Beans /*
  <harvestcraft:bakedbeetsItem>,    /* 2 - Baked Beets /*
  <minecraft:baked_potato>,   /* 3 - Baked Potato /*
  <harvestcraft:bakedsweetpotatoItem>,    /* 4 - Baked Sweet Potato /*
  <harvestcraft:bakedturnipsItem>,    /* 5 - Baked Turnips /*
  <harvestcraft:bamboosteamedriceItem>,   /* 6 - Bamboo Steamed Rice /*
  <harvestcraft:beansandriceItem>,    /* 7 - Beans and Rice /*
  <harvestcraft:boiledeggItem>,   /* 8 - Boiled Egg /*
  <harvestcraft:loadedbakedpotatoItem>,   /* 9 - Loaded Baked Potato /*
  <harvestcraft:mapleoatmealItem>,    /* 10 - Maple Oatmeal /*
  <harvestcraft:marinatedcucumbersItem>,    /* 11 - Marinated Cucumbers /*
  <harvestcraft:mashedpotatoesItems>,   /* 12 - Mashed Potatoes /*
  <harvestcraft:picklesItem>,   /* 13 - Pickles /*
  <harvestcraft:poachedpearItem>,   /* 14 - Poached Pear /*
  <harvestcraft:potatoandcheesepirogiItem>,   /* 15 - Potato and Cheese Pirogi /*
  <harvestcraft:rainbowcurryItem>,    /* 16 - Rainbow Curry /*
  <harvestcraft:refriedbeansItem>,    /* 17 - Refried Beans /*
  <harvestcraft:veggiestirfryItem>,   /* 18 - Veggie Stirfry /*
  <harvestcraft:zestyzucchiniItem>,   /* 19 - Zesty Zucchini /*
  <harvestcraft:stuffedmushroomItem>,   /* 20 - Stuffed Mushroom /*
  <harvestcraft:stuffedpepperItem>    /* 21 - Stuffed Pepper /*
] as IItemStack[];

val foodGroupVegetarianthree = [
  <harvestcraft:creamedcornItem>,   /* 0 - Creamed Corn /*
  <harvestcraft:curryriceItem>,   /* 1 - Curry Rice /*
  <harvestcraft:eggnogItem>,    /* 2 - Egg Nog /*
  <harvestcraft:eggplantparmItem>,    /* 3 - Eggplant Parm /*
  <harvestcraft:friedeggItem>,    /* 4 - Fried Egg /*
  <harvestcraft:friedriceItem>,   /* 5 - Fried Rice /*
  <harvestcraft:garlichmashedpotatoesItem>,   /* 6 - Garlic Mashed Potatoes /*
  <harvestcraft:glazedcarrotsItem>,   /* 7 - Glazed Carrots /*
  <harvestcraft:grilledasparagusItem>,    /* 8 - Grilled Asparagus /*
  <harvestcraft:grilledeggplantItem>,   /* 9 - Grilled Eggplant /*
  <harvestcraft:grilledmushroomItem>,   /* 10 - Grilled Mushroom /*
  <harvestcraft:heartybreakfastItem>,   /* 11 - Hearty Breakfast /*
  <harvestcraft:roastpotatoesItem>,   /* 12 - Roast Potatoes /*
  <harvestcraft:roastedpumkinseedsItem>,    /* 13 - Roasted Pumpkin Seeds /*
  <harvestcraft:roastedrootveggiemedleyItem>,   /* 14 - Roasted Root Veggie Medley /*
  <harvestcraft:scallionbakedpotatoItem>,   /* 15 - Scallion Baked Potato /*
  <harvestcraft:scrambledeggItem>,    /* 16 - Scrambled Egg /*
  <harvestcraft:zucchinibakeItem>,    /* 17 - Zucchini Bake /*
  <harvestcraft:spicygreensItem>,   /* 18 - Spicy Greens /*
  <harvestcraft:steamedpeasItem>,   /* 19 - Steamed Peas /*
  <harvestcraft:steamedspinachItem>,    /* 20 - Steamed Spinach /*
  <harvestcraft:stuffedeggplantItem>,   /* 21 - Stuffed Eggplant /*
] as IItemStack[];
